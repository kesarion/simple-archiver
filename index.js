...
var tar      = require('tar');
   ...
   *   @param {String} [options.output=buffer] - Output type: 'buffer', 'stream', '/path'; default: 'buffer'; If you enter a path string, the archive will be saved there, resolve value will be the path string
   *
